  ...
  return (
    <div>
      ...
      <div className="relative">
        <input type={show ? "text" : "password"} {...reg(name, rules)}
    ...
    <div className="min-h-full flex items-center justify-center py-8 px-4">
      <div className="w-full max-w-md space-y-5">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-0.5">Change your portal login password</p>
        </div>

      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <PasswordField label="Current Password" name="current_password" register={register}
            rules={{ required: "Current password is required" }}
            error={errors.current_password} placeholder="••••••••" />
          <PasswordField label="New Password" name="new_password" register={register}
          ...
          <PasswordField label="Confirm New Password" name="confirm_password" register={register}
