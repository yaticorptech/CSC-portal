...
import { LayoutDashboard, Users, UserPlus, LogOut, Menu, X, KeyRound } from "lucide-react";
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <button
          ...
          className="absolute bottom-6 left-4 right-4 flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-colors"
        >
          <LogOut size={18} />
          Logout
        </button>
